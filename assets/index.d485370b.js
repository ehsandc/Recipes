...
}`),QI=()=>{const[e,t]=v.exports.useState(""),[n,r]=v.exports.useState(""),o=Zw.hits.filter(a=>{const i=e.toLowerCase().replace("-"," "),s=a.recipe.label.toLowerCase().includes(i),l=a.recipe.healthLabels.some(d=>d.toLowerCase().includes(i)),u=a.recipe.dietLabels.some(d=>d.toLowerCase().includes(i)),c=!n||a.recipe.healthLabels.includes(n);return(e===""||s||l||u)&&c});return T(et,{bg:"#4299E1",minH:"100vh",py:8,children:G(Vm,{maxW:"container.xl",children:[G(kw,{mb:8,flexDir:"column",children:[T(Bm,{value:e,onChange:a=>t(a.target.value),placeholder:"Search recipes...",size:"lg",maxW:"md",bg:"white",borderRadius:"md",mb:4}),G(il,{spacing:4,children:[T(ri,{colorScheme:n==="Vegetarian"?"green":"gray",onClick:()=>r(n==="Vegetarian"?"":"Vegetarian"),children:"Vegetarian"}),T(ri,{colorScheme:n==="Vegan"?"green":"gray",onClick:()=>r(n==="Vegan"?"":"Vegan"),children:"Vegan"}),T(ri,{colorScheme:n==="Pescatarian"?"green":"gray",onClick:()=>r(n==="Pescatarian"?"":"Pescatarian"),children:"Pescatarian"})]})]}),o.length===0?T(et,{bg:"white",p:8,borderRadius:"xl",textAlign:"center",children:T(ft,{fontSize:"xl",children:"No recipes found. Please try a different search term."})}):T(Fw,{columns:[1,2,3,4],spacing:6,children:o.map(a=>{var i,s;return T(Km,{to:`/recipe/${a.recipe.label}`,children:G(et,{bg:"white",borderRadius:"xl",overflow:"hidden",transition:"transform 0.2s",_hover:{transform:"scale(1.02)"},height:"450px",display:"flex",flexDirection:"column",children:[T(jm,{src:a.recipe.image,alt:a.recipe.label,height:"200px",objectFit:"cover"}),G(et,{p:4,flex:"1",display:"flex",flexDirection:"column",children:[T(ft,{fontSize:"xl",fontWeight:"semibold",mb:2,noOfLines:2,children:a.recipe.label}),G(et,{flex:"1",children:[G(il,{mb:2,children:[T(ft,{fontWeight:"bold",children:"Meal Type:"}),T(ft,{noOfLines:1,children:((i=a.recipe.mealType)==null?void 0:i[0])||"Not specified"})]}),G(il,{mb:2,children:[T(ft,{fontWeight:"bold",children:"Dish Type:"}),T(ft,{noOfLines:1,children:((s=a.recipe.dishType)==null?void 0:s[0])||"Not specified"})]})]}),G(et,{children:[a.recipe.dietLabels.length>0&&T(qr,{gap:2,flexWrap:"wrap",mb:2,children:a.recipe.dietLabels.map(l=>T(Mo,{colorScheme:"green",size:"sm",children:l},l))}),a.recipe.cautions.length>0&&T(qr,{gap:2,flexWrap:"wrap",children:a.recipe.cautions.map(l=>T(Mo,{colorScheme:"red",size:"sm",children:l},l))})]})]})]})},a.recipe.label)})})]})})},JI=()=>{var r;const{id:e}=rI(),t=Dw(),n=Zw.hits.find(o=>o.recipe.label===e);return n?T(et,{bg:"#4299E1",minH:"100vh",py:8,children:G(Vm,{maxW:"container.xl",children:[T(ri,{onClick:()=>t(-1),mb:4,variant:"solid",bg:"white",children:"Back to Overview"}),T(et,{bg:"white",borderRadius:"xl",overflow:"hidden",p:8,children:T(Rw,{spacing:6,align:"stretch",children:G(qr,{direction:{base:"column",md:"row"},gap:8,children:[T(jm,{src:n.recipe.image,alt:n.recipe.label,borderRadius:"xl",maxW:{base:"100%",md:"50%"},objectFit:"cover"}),G(et,{flex:"1",children:[T(ft,{color:"gray.500",fontSize:"sm",mb:2,textTransform:"uppercase",children:((r=n.recipe.mealType)==null?void 0:r[0])||"MEAL"}),T(sl,{as:"h1",size:"xl",mb:4,children:n.recipe.label}),G(ft,{fontSize:"lg",mb:2,children:["Total Cooking Time: ",n.recipe.totalTime===0?"Unknown":`${n.recipe.totalTime} minutes`]}),G(ft,{fontSize:"lg",mb:4,children:["Servings: ",n.recipe.yield]}),G(et,{mb:6,children:[T(sl,{as:"h2",size:"md",mb:2,children:"Ingredients:"}),T(Aw,{spacing:2,children:n.recipe.ingredientLines.map((o,a)=>T(Ew,{children:o},a))})]}),G(et,{mb:4,children:[T(ft,{fontWeight:"bold",mb:2,children:"Health labels:"}),T(qr,{flexWrap:"wrap",gap:2,children:n.recipe.healthLabels.map(o=>T(Mo,{colorScheme:"purple",textTransform:"uppercase",size:"sm",children:o},o))})]}),G(et,{mb:4,children:[T(ft,{fontWeight:"bold",mb:2,children:"Diet:"}),T(qr,{flexWrap:"wrap",gap:2,children:n.recipe.dietLabels.map(o=>T(Mo,{colorScheme:"green",textTransform:"uppercase",size:"sm",children:o},o))})]}),n.recipe.cautions.length>0&&G(et,{children:[T(ft,{fontWeight:"bold",mb:2,children:"Cautions:"}),T(qr,{flexWrap:"wrap",gap:2,children:n.recipe.cautions.map(o=>T(Mo,{colorScheme:"red",textTransform:"uppercase",size:"sm",children:o},o))})]})]})]})})})]})}):T(Center,{h:"100vh",children:T(sl,{children:"Recipe not found!"})})},ez=()=>G("div",{style:{padding:"20px",backgroundColor:"#4299E1",minHeight:"100vh",color:"white"},children:[T("h1",{children:"Recipe App Loading..."}),T("p",{children:"If you see this, React is working!"}),T(OI,{children:G(bI,{children:[T(Of,{path:"/",element:T(QI,{})}),T(Of,{path:"/recipe/:id",element:T(JI,{})})]})})]});Bf.createRoot(document.getElementById("root")).render(T(Jl.StrictMode,{children:T(Jq,{children:T(ez,{})})}));
